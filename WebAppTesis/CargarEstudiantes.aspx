<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="SiteMenu.Master" CodeFile="CargarEstudiantes.aspx.vb" Inherits="CargarEstudiantes" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table border="0" style="margin: 0 auto;border-collapse: separate; border-spacing: 2px; width:100%">
        <tr>
            <td align="center">
                <dx:ASPxLabel runat="server" Text="CARGAR INFORMACION DE ESTUDIANTES" Width="100%" BackColor="#993333" Font-Bold="True" ForeColor="White" ID="ASPxLabel1" Font-Size="18px">
                </dx:ASPxLabel>
            </td>
        </tr>
        <tr>
